# Awesome the book of secret knowledge with stars
...
[<img src="https://opencollective.com/the-book-of-secret-knowledge/contributors.svg?width=890&button=false">](https://github.com/trimstray/the-book-of-secret-knowledge/graphs/contributors) ⭐ 240,602 | 🐛 170 | 📅 2024-11-19
...
GitHub exposes an [RSS/Atom](https://github.com/trimstray/the-book-of-secret-knowledge/commits.atom) ⭐ 240,602 | 🐛 170 | 📅 2024-11-19 feed of the commits, which may also be useful if you want to be kept informed about all changes.
...
> Look also: [A naive utility to censor credentials in command history](https://github.com/lbonanomi/go/blob/master/revisionist.go) ⭐ 8 | 🐛 0 | 🌐 Go | 📅 2025-05-03.
...
* [openssl objects.txt](https://github.com/openssl/openssl/blob/master/crypto/objects/objects.txt) ⭐ 30,700 | 🐛 1,528 | 🌐 C | 📅 2026-08-27
...
##### Tool: [system-other](https://github.com/trimstray/the-book-of-secret-knowledge#tool-system-other) ⭐ 240,602 | 🐛 170 | 📅 2024-11-19
...
##### Tool: [network-other](https://github.com/trimstray/the-book-of-secret-knowledge#tool-network-other) ⭐ 240,602 | 🐛 170 | 📅 2024-11-19
